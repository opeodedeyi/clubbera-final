...
const MemberTableRow = ({ name, role, birthday, dateJoined, gender, email }) => {
    return (
        <tr>
            <td className={style.editGeneralTableName}>
                <div className={style.editGeneralTableImage}><img src="/profile_image.png" alt="profile-photo"/></div>
