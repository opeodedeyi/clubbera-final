...
const HeroSection = () => (
    <div className={style.homepageHero}>
        ...
        {/* Hero section images */}
        <div className={`${style.homepageHeroImage} ${style.heroPosFour}`}></div>
        <div className={`${style.homepageHeroImage} ${style.heroPosFive}`}></div>
        <div className={`${style.homepageHeroImage} ${style.heroPosSix}`}></div>
        <div className={`${style.homepageHeroImage} ${style.heroPosSeven}`}></div>
    </div>
);
