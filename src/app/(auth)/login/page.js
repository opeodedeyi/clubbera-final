...
export default function Login({ searchParams }) {
    ...
    const { email, setEmail, password, setPassword, submitLogin, loading, errors } = useLoginForm(destination);
        ...
        <div className={style.authContainer}>
            <form
                ...
                <div className={style.authFormContent}>
                    ...
                    {errors.general && (
                      <MainTip theme="dangerTheme">{errors.general}</MainTip>
                    )}
                ...
                <div className={style.authFormActions}>
                    ...
                    <p className={style.authFormActionsCta}>
                        Not a member yet? <Link href="/signup">Sign up now</Link>
                    </p>
                </div>
            </form>
        </div>
