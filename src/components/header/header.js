    ...
    return (
        <div className="header-profile-photo-card">
            <div className="header-profile-photo-img">
                <img src={user?.avatar ? user.profilePhoto.location : "/profile.png"}/>
            </div>
        ...
        return (
            <>
                <div>
                    ...
                    <button className="header-toggle-bar mobile-only-show" onClick={navBtnClicked}>
                ...
                <div className="flex-c">
                    <div className="flex-c header-buttons-alt mobile-only-show">
                        <button className="header-toggle-bar-alt">
